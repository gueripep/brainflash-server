...
from app.pydantic.flashcard import FlashcardFSRSReadSchema, update_flashcard_fsrs_orm_from_dto
...
async def update_fsrs(flashcard_id: str, payload: FlashcardFSRSReadSchema, session: AsyncSession = Depends(get_db)):
    """
    ...
    pydantic_fsrs = FlashcardFSRSReadSchema.model_validate(payload)
